            ...
            try {
                ...
                const productsData = products.map(product => {
                    ...
                    return {
                        ...
                        custo_base: product.baseCost || product.cost || 0,
                        preco_venda: product.finalPrice || product.price || 0,
                        margem_lucro: product.profitMargin || product.margem_contribuicao || 0,
        ...
        try {
            ...
            const supabaseData = {
                products: (productsResult.data || []).map(p => ({
                    ...
                    baseCost: parseFloat(p.custo_base || p.preco_custo || 0),
                    cost: parseFloat(p.custo_base || p.preco_custo || 0),
                    finalPrice: parseFloat(p.preco_venda || 0),
                    price: parseFloat(p.preco_venda || 0),
                    profitMargin: p.margem_lucro,
                    margem_contribuicao: p.margem_contribuicao || p.margem_lucro,
