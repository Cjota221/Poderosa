        ...
        bindAddEditProductEvents() {
            ...
            const updateVariationUI = () => {
                ...
                if (selectedType === 'none') {
                    container.innerHTML = `<div class="form-group"><label>Estoque Total</label><input type="number" class="form-input" id="stock-total" placeholder="Ex: 50"></div>`;
                } else if (selectedType === 'simple') {
                    container.innerHTML = `<div class="form-group"><label>Nome da Variação (Ex: Tamanho)</label><input type="text" class="form-input" id="variation-name-1" placeholder="Ex: Tamanho"></div><div class="form-group"><label>Opções (Aperte Enter para adicionar)</label><input type="text" class="form-input" id="variation-options-input-1" placeholder="Ex: P, M, G..."><div class="variation-options-container" id="variation-options-tags-1"></div></div><div id="simple-stock-table"></div>`;
                } else if (selectedType === 'combined') {
                    container.innerHTML = `<p>Variação Combinada em desenvolvimento.</p>`;
                }
            };
